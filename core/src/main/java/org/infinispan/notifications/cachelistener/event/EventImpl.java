 ...
 */
@NotThreadSafe
public class EventImpl<K, V> implements CacheEntryActivatedEvent, CacheEntryCreatedEvent, CacheEntriesEvictedEvent, CacheEntriesExpiredEvent, CacheEntryLoadedEvent, CacheEntryModifiedEvent,
